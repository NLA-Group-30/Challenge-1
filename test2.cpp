...
int main(int argc, char* argv[]) {
	...
	Eigen::VectorXd original_vector =
		Eigen::Map<Eigen::VectorXd>(original_matrix.data(), height * width);
	Eigen::VectorXd noisy_vector =
		Eigen::Map<Eigen::VectorXd>(noisy_matrix.data(), height * width);
